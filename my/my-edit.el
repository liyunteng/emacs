...
(after-load 'mule
  ...
  (when (or window-system (my-locale-is-utf8-p))
    ...
    (setq locale-coding-system 'utf-8-with-signature)
    (set-default-coding-systems 'utf-8-with-signature)
    (set-terminal-coding-system 'utf-8-with-signature)
    (set-keyboard-coding-system 'utf-8)
    (set-selection-coding-system (if (eq system-type 'windows-nt) 'utf-16-le 'utf-8-with-signature))
