...
(my|view-buffer "*ag search*")
(my|view-buffer "*grep*")
(my|view-buffer "*Occur*")
(my|view-buffer "*compilation*")
...
(global-set-key (kbd "M-g a") 'my/switch-buffer-other-window--*ag\ search*)
(global-set-key (kbd "M-g r") 'my/switch-buffer-other-window--grep)
(global-set-key (kbd "M-g o") 'my/switch-buffer-other-window--Occur)
(global-set-key (kbd "M-g RET") 'my/switch-buffer-other-window--compilation)
...
(global-set-key (kbd "M-g A") 'my/view-buffer-other-window--*ag\ search*)
(global-set-key (kbd "M-g R") 'my/view-buffer-other-window--grep)
(global-set-key (kbd "M-g O") 'my/view-buffer-other-window--Occur)
